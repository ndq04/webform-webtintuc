<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="SuaBaiViet.aspx.cs" Inherits="TinTuc.Admin.SuaBaiViet" %>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Id Bài Viết<span class="text-danger">*</span></label>
                                <div class="col-sm-10">
                                    <asp:TextBox runat="server" ID="txtMaBV" type="text" class="form-control" />
                                </div>
                            </div>
